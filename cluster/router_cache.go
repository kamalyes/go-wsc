 ...
 * @FilePath: \go-wsc\cluster\router_cache.go
 * @Description: 分布式路由缓存
...
// cfg: 缓存配置（nil 使用默认值）
func NewRouterCache(redisClient redis.UniversalClient, onlineRepo spi.OnlineStore, cfg *wscconfig.RouterCacheConfig) *RouterCache {
