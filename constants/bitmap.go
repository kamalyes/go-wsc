...
const (
	...
	// Lua 脚本(luaBatchSetClientsOnlineV2/OfflineV2)硬编码 "__global__" 须与本常量同值，修改时同步
	...
	// DefaultBitmapTTLSeconds bitmap EXPIRE 默认秒数（HeartbeatRefreshInterval 2s × 4 = 8s）
	DefaultBitmapTTLSeconds = 8

	// DefaultBitmapMigrationPhase 默认灰度阶段
	DefaultBitmapMigrationPhase = "dual-write"
)
