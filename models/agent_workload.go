...
// FormatKeyPart 格式化 Redis key 的维度部分（包含冒号分隔符）
// realtime: "realtime"
// hourly: "hourly:2026022513"
// daily: "daily:20260225"
func (d WorkloadDimension) FormatKeyPart(t time.Time) string {
	timeKey := d.FormatTimeKey(t)
	if timeKey == "" {
		return string(d)
	}
	return string(d) + ":" + timeKey
}
