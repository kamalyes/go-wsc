...
// @FilePath: \go-wsc\models\pb\wsc.pb.go
// @Description: Hub 消息 protobuf 序列化定义（跨节点高效传输）
//
// HubMessageProto 为 HubMessage 的 protobuf 表示，配合 node.proto 的 gRPC
// 通道使用；相比 JSON 序列化体积更小，适合节点间高频转发路径。
//
...
func (x *DistributedMessageProto) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *DistributedMessageProto) GetGroupIds() []string {
	if x != nil {
		return x.GroupIds
	}
	return nil
